...
- Location: tests/sales/receipt-load-stress.spec.ts:157:9
...
Error: Invoice-Receipt API Creation Failed after 3 attempts. Last error: Attempt 3: Error: Validation Error (422): {
	"code": 422,
	"message": "invoice is already fully paid: invoice INV/2026/08/18/002481 outstanding balance is 100.00 but 1500.00 was applied"
}
...
```ts
  ...
  644 | 
  645 |       } catch (error) {
  646 |         lastError = `Attempt ${attempt}: ${error}`;
  647 |         console.warn(`[WARN] Receipt creation error on attempt ${attempt}:`, error);
  648 | 
  649 |         if (attempt < 3) {
