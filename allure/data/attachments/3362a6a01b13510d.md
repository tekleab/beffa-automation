...
```
Error: BUG: ERP returns 500 "Unable to create Payment" on approved bill partial payment. Invoice: e9ef9bc4-c1b4-4a89-9850-b947ba8f3082. Error: Bill-Payment API failed: 500 - {
	"code": 500,
