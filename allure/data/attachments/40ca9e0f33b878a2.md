...
- Name: inventory/inv-avg-audit.spec.ts >> Weighted Average Costing Forensic Audit @inventory @security @costing @regression @full >> Audit: 7-Stage Average Cost Validation & COGS Accuracy
- Location: tests/inventory/inv-avg-audit.spec.ts:14:9
