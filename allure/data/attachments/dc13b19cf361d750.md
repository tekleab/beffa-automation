...
- Name: sales/so-load.spec.ts >> Load: Concurrent Sales Invoices @sales @full >> LOAD: AR balance after 5 concurrent approved invoices must equal sum of all amounts
...
```ts
  16  | test.describe('Load: Concurrent Sales Invoices @sales @full', () => {
