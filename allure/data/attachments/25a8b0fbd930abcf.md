...
```
Error: Bill BILL/2026/08/17/001768 should be visible in vendor "Gentium Concrite Industry" profile Bills tab
              ...
              - generic [ref=e210]:
                - generic [ref=e211]:
                  ...
                  - generic [ref=e221]:
                    ...
                    - paragraph [ref=e227]: 389,495,698.75
                - generic [ref=e228]:
                  ...
                  - generic [ref=e259]:
                    - table [ref=e262]:
                      ...
                      - rowgroup [ref=e273]:
                        ...
                        - row "BILL/2026/08/05/000382 September 15, 2026 Draft 2000" [ref=e318]:
                          - cell "BILL/2026/08/05/000382" [ref=e319]:
                            - link "BILL/2026/08/05/000382" [ref=e321] [cursor=pointer]:
                        ...
                        - row "BILL/2026/08/05/000393 September 15, 2026 Draft 4900" [ref=e329]:
                          - cell "BILL/2026/08/05/000393" [ref=e330]:
                            - link "BILL/2026/08/05/000393" [ref=e332] [cursor=pointer]:
                        ...
                        - row "BILL/2026/08/04/000359 September 15, 2026 Approved 2000" [ref=e417]:
                          - cell "BILL/2026/08/04/000359" [ref=e418]:
                            - link "BILL/2026/08/04/000359" [ref=e420] [cursor=pointer]:
...
```ts
  ...
  107 |             } else {
  108 |                 expect(fallbackVisible, 'Bills tab should be visible on vendor profile page').toBe(true);
  109 |             }
  110 |         }
  111 |         await page.waitForTimeout(3000);
  112 | 
  113 |         console.log(`[STEP 5] Asserting bill ${bill.ref} is visible in vendor profile Bills tab...`);
  114 |         let billVisible = false;
  115 |         for (let attempt = 0; attempt < 10; attempt++) {
  116 |             billVisible = await page.getByText(bill.ref).first().isVisible({ timeout: 5000 }).catch(() => false);
  117 |             if (billVisible) break;
  118 |             console.log(`[POLL ${attempt + 1}/10] Bill not yet visible, waiting...`);
  119 |             await page.waitForTimeout(3000);
  120 |             if (attempt % 3 === 2) {
  121 |                 await page.reload({ waitUntil: 'domcontentloaded' });
  122 |                 await page.waitForTimeout(2000);
  123 |                 const bt = page.getByRole('tab', { name: /Bills/i }).first();
  124 |                 await bt.waitFor({ state: 'visible', timeout: 10000 }).catch(() => {});
  125 |                 await bt.click().catch(() => {});
  126 |                 await page.waitForTimeout(2000);
  127 |             }
  128 |         }
  129 | 
  130 |         if (!billVisible) {
  131 |             const rowCount = await page.locator('table tbody tr').count();
  132 |             console.log(`[DEBUG] Rows in Bills tab: ${rowCount}`);
> 133 |             expect(billVisible, `Bill ${bill.ref} should be visible in vendor "${vendorName}" profile Bills tab`).toBe(true);
      |                                                                                                                   ^ Error: Bill BILL/2026/08/17/001768 should be visible in vendor "Gentium Concrite Industry" profile Bills tab
  134 |         }
  135 | 
  136 |         console.log(`[PASS] Bill ${bill.ref} confirmed visible in vendor "${vendorName}" profile. Outstanding balance reflected.`);
  137 |     });
  138 | });
  139 | 
```