...
- Name: sales/sales-so-guardrails.spec.ts >> Sales SO Guardrails @sales @logic @regression >> Guardrail: System must reject Invoicing for more units than the approved SO
- Location: tests/sales/sales-so-guardrails.spec.ts:31:9
...
```ts
  ...
  9  |  */
  10 | 
  11 | test.describe('Sales SO Guardrails @sales @logic @regression', () => {
