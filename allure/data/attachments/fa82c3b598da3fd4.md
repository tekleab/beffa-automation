                  ...
                  - generic [ref=e208]:
                    ...
                    - generic [ref=e215]:
                      - group [ref=e216]:
                        ...
                        - textbox "Invoice number" [disabled] [ref=e219]: BILL/2026/08/03/000277
                ...
                - generic [ref=e246]:
                  ...
                  - tabpanel "Purchases" [ref=e260]:
                    - table [ref=e264]:
                      ...
                      - rowgroup [ref=e291]:
                        - row "inventory/RWT-5 - Harmony flex 4 2500 Goods Prepaid Rent 10000 15 11,500.00" [ref=e292]:
                          - cell [ref=e293]
                          ...
                          - cell [ref=e305]
                          - cell "Prepaid Rent" [ref=e306]:
                            - generic [ref=e308]: Prepaid Rent
                          - cell [ref=e309]
                          - cell "10000" [ref=e310]:
...
```ts
  ...
  684 |         await page.goto('/payables/bills/new', { waitUntil: 'commit' });
  685 | 
...
> 695 |         await page.getByRole('button', { name: 'Add Now' }).first().click();
  ...
  705 |         await page.goto('/payables/bills/new', { waitUntil: 'commit' });
  706 | 
  ...
  731 |         await page.goto('/payables/bills/new', { waitUntil: 'commit' });
  732 | 
