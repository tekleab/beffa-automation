...
- Name: purchase/audit/po-doc-integrity.spec.ts >> Procurement Document Integrity Attacks @purchase @security @logic @regression @full >> Guardrail: System must block billing beyond 100% of PO quantity
- Location: tests/purchase/audit/po-doc-integrity.spec.ts:65:9

# Error details

```
Error: [CRITICAL_LOGIC_BUG] System approved a bill for 1 unit beyond the fully-exhausted PO PO/2026/06/05/000126. Over-receiving liability created.
```
