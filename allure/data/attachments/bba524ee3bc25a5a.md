...
Error: Multi-bill payment failed: 422 - {
	...
	"details": {
		"cash_account_id": [
			"insufficient balance in account Cash - Main Office: available 0.00, required 5000.00"
		]
	},
...
```ts
  ...
  17  |     let sharedItem: Awaited<ReturnType<AppManager['api']['inventory']['captureRandomItemDataAPI']>>;
  18  | 
  ...
  24  |         sharedItem = await app.api.inventory.captureRandomItemDataAPI();
  25  |         await page.close();
  26  |     });
  27  | 
