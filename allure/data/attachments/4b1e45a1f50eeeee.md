...
- Name: inventory/inventory-concurrency-race.spec.ts >> Inventory Concurrency & Race Condition Audits@inventory @concurrency @security @regression @full >> Guardrail: System must handle concurrent stock adjustments atomically
- Location: tests/inventory/inventory-concurrency-race.spec.ts:15:9

# Error details

```
Error: [CRITICAL_LOGIC_BUG] Stock Race Condition: Concurrent adjustments caused lost updates. Expected 1042, found 0.
```
