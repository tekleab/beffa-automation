...
- Name: sales/so-period-control.spec.ts >> Sales Period Control Edge Cases @sales @security @temporal @regression @full >> Edge Case: Reject invalid date (Feb 30, 2018)
- Location: tests/sales/so-period-control.spec.ts:255:9
