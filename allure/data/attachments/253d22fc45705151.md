...
- Name: purchase/procurement-document-integrity.spec.ts >> Procurement Document Integrity Attacks @purchase @security @logic @regression @full >> Guardrail: System must reject approval of a future-dated Bill
- Location: tests/purchase/procurement-document-integrity.spec.ts:35:9

# Error details

```
Error: [CRITICAL_LOGIC_BUG] System approved a bill dated 2028-05-28T00:00:00Z. Future-period AP liability injection possible — balance sheet manipulation.
```
