...
- Name: sales/so-period-control.spec.ts >> Sales Period Control Edge Cases @sales @full >> SO: Reject future-dated Sales Order from next fiscal year (2022)
...
```ts
  ...
  29  |  */
  30  | 
  31  | test.describe('Sales Period Control Edge Cases @sales @full', () => {
