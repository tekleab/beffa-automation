...
- Name: sales/period-control/so-period-control.spec.ts >> Sales Period Control Edge Cases @sales @security @temporal @regression @full >> Edge Case: Reject date with negative timestamp (epoch manipulation)
- Location: tests/sales/period-control/so-period-control.spec.ts:283:9
