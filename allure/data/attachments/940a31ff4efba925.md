...
```
Error: BUG: ERP returns 500 "Unable to create Payment" on approved bill partial payment. Invoice: 14da82a0-d1fb-49b2-ba76-21bac584c10a. Error: Bill-Payment API failed: 500 - {
	"code": 500,
