...
```
Error: [VULNERABILITY] System accepted a stock adjustment on a deactivated item (Ref: ADJ/2026/08/12/002180). Fix: validate item.status == active before creating adjustments.
```
