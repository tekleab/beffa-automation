...
```
Error: Invoice-Receipt API Creation Failed after 3 attempts. Last error: Attempt 3: Error: page.waitForTimeout: Target page, context or browser has been closed
```
