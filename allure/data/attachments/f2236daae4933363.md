...
```
Error: BUG: ERP returns 500 "Unable to create Payment" on approved bill partial payment. Invoice: 81d748aa-677c-48cd-94a7-292a7f2852af. Error: Bill-Payment API failed: 500 - {
	"code": 500,
