...
- Name: purchase/procurement-period-control-edge-cases.spec.ts >> Procurement Period Control Edge Cases @purchase @security @temporal @regression @full >> Payment: Reject back-dated Payment from previous fiscal year (2017)
- Location: tests/purchase/procurement-period-control-edge-cases.spec.ts:165:9
