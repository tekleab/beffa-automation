...
- Location: tests/purchase/po-doc-integrity.spec.ts:65:9

# Error details

```
Error: [CRITICAL_LOGIC_BUG] System approved a bill for 1 unit beyond the fully-exhausted PO PO/2026/06/05/000153. Over-receiving liability created.
```
