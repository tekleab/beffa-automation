...
- Name: purchase/procurement-period-control-edge-cases.spec.ts >> Procurement Period Control Edge Cases @purchase @security @temporal @regression @full >> PO: Reject future-dated Purchase Order from next fiscal year (2019)
- Location: tests/purchase/procurement-period-control-edge-cases.spec.ts:71:9
