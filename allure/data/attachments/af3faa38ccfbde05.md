...
Locator: getByText('UI-CREATE-1781102919305').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for getByText('UI-CREATE-1781102919305').first()
                  ...
                  - generic [ref=e205]:
                    - generic [ref=e206]:
                      - generic [ref=e207]:
                        - group [ref=e208]:
                          ...
                          - textbox "Code/ID *" [ref=e211]: UI-CREATE-1781102919305
                        - group [ref=e212]:
                          - generic [ref=e213]: Name *
                          - textbox "Name *" [ref=e215]: UI-CREATE-1781102919305
                      - group [ref=e216]:
                    ...
                    - generic [ref=e238]:
                      ...
                      - group [ref=e251]:
                        ...
                        - textbox "Part Number" [ref=e254]: PN-25339
                      - group [ref=e255]:
                    ...
                    - generic [ref=e263]:
                      - group [ref=e264]:
                        ...
                        - button "GL Cost Account selector" [ref=e266]: Withholding Tax Receivable
                      - group [ref=e267]:
                        - generic [ref=e268]: GL Sales Account *
                        - button "GL Sales Account selector" [ref=e269]: Cash at Bank - Zemen
                      - group [ref=e270]:
                        - generic [ref=e271]: GL Inventory Account *
                        - button "GL Inventory Account selector" [ref=e272]: Prepayment
                      - group [ref=e274]:
...
> 76  |         await expect(page.getByText(itemCode).first()).toBeVisible({ timeout: 15000 });
  ...
  114 |         const item = await app.api.inventory.captureRandomItemDataAPI({ minStock: 1 });
  115 | 
  116 |         if (!item) {
