...
- Name: sales/sales-period-control-edge-cases.spec.ts >> Sales Period Control Edge Cases @sales @security @temporal @regression >> Edge Case: Reject date with negative timestamp (epoch manipulation)
