...
- Name: purchase/guardrails/po-stress.spec.ts >> Procurement Stress & Financial Edge Cases @purchase @logic @security @regression @full >> Guardrail: System must prevent double-billing the same PO
- Location: tests/purchase/guardrails/po-stress.spec.ts:67:9

# Error details

```
Error: [CRITICAL_LOGIC_BUG] Double-billing allowed! PO PO/2026/06/04/000117 billed twice: BILL/2026/06/04/000379 + BILL/2026/06/04/000381. Duplicate liability created.
