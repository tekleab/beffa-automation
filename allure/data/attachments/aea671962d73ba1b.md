...
```
Error: BUG: ERP returns 500 "Unable to create Payment" on approved bill partial payment. Invoice: 66b4a490-cbc8-4a87-8054-f5c4a9836c42. Error: Bill-Payment API failed: 500 - {
	"code": 500,
