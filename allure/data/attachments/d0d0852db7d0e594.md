...
- Name: hr/hr-employees.spec.ts >> HR: Employee Lifecycle @hr @smoke >> Guardrail: Employee creation must reject payload missing required fields
- Location: tests/hr/hr-employees.spec.ts:64:9
