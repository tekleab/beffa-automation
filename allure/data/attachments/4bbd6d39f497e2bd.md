...
- Name: purchase/period-control/po-period-control.spec.ts >> Procurement Period Control Edge Cases @purchase @security @temporal @regression @full >> PO: Reject future-dated Purchase Order from next fiscal year (2019)
- Location: tests/purchase/period-control/po-period-control.spec.ts:71:9
