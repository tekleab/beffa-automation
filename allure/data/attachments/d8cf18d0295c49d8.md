...
```
Error: [CRITICAL_LOGIC_BUG] Bill BILL/2026/08/26/002795: Balance drift after partial payment 1. Expected 6000, got -1
...
```
Error: [CRITICAL_LOGIC_BUG] Bill BILL/2026/08/26/002795: Balance drift after partial payment 2. Expected 3000, got -1
...
```
Error: [CRITICAL_LOGIC_BUG] Bill BILL/2026/08/26/002795: Balance drift after partial payment 3. Expected 0, got -1
