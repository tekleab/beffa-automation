...
- Name: inventory/inventory-security-temporal.spec.ts >> Inventory Temporal & Data Isolation Audits @security @inventory >> Guardrail: System must explicitly reject historical back-dated adjustments
...
```ts
  ...
  10 |  */
  11 | 
  12 | test.describe('Inventory Temporal & Data Isolation Audits @security @inventory', () => {
