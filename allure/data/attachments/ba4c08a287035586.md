...
- Name: sales/sales-period-control-edge-cases.spec.ts >> Sales Period Control Edge Cases @sales @security @temporal @regression @full >> Invoice: Reject future-dated Invoice from next fiscal year (2019)
