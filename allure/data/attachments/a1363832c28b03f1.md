...
- Name: sales/sales-negative-api.spec.ts >> Sales Order Negative API Tests @negative >> Boundary: Block Negative Quantity
- Location: tests/sales/sales-negative-api.spec.ts:153:9
