...
```
Error: [CRITICAL_LOGIC_BUG] Integrity Collapse: Duplicate Receipt for INV/2026/04/28/000049 was CREATED, APPROVED, and POSTED.
```
...
```ts
  ...
  49  |         const item = await app.api.inventory.captureRandomItemDataAPI();
  ...
  55  |             quantity: 10,
  56  |             unitPrice: 5000,
  57  |             locationId: meta.locationId,
  58  |             warehouseId: meta.warehouseId
  59  |         });
  60  | 
  61  |         // ⚡ Speed Approval
