...
Call log:
  ...
  - waiting for locator('.chakra-modal__content, .chakra-popover__content, [role="dialog"]').filter({ hasText: /Warehouse \*|G\/L Account \*|Description/i }).first()
    18 × locator resolved to <section tabindex="-1" role="dialog" id="popover-content-:rds:" aria-describedby="popover-body-:rds:" class="chakra-popover__content css-1rnzimv">…</section>
      ...
      - generic [ref=e313]:
        - generic [ref=e314]:
          - group [ref=e316]:
            ...
            - button "Item selector" [ref=e318]: Control panal
          - group [ref=e320]:
