...
Call log:
  ...
  - waiting for locator('.chakra-modal__content, .chakra-popover__content, [role="dialog"]').filter({ hasText: /Warehouse \*|G\/L Account \*|Description/i }).first()
    19 × locator resolved to <section tabindex="-1" role="dialog" id="popover-content-:rg3:" aria-describedby="popover-body-:rg3:" class="chakra-popover__content css-unt9s1">…</section>
      ...
      - generic [ref=e306]:
        - generic [ref=e307]:
          - group [ref=e309]:
            ...
            - button "Item selector" [ref=e311]: Sauna door DGL 8X19 ASPEN
          - group [ref=e313]:
            - generic [ref=e314]: Warehouse *
            - button "Warehouse selector" [ref=e315]: Default Warehouse
          - group [ref=e317]:
            - generic [ref=e318]: Location *
            - button "Location selector" [ref=e319]: Default Warehouse Location
          - group [ref=e321]:
