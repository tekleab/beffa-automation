...
- Name: purchase/purchase-negative-api.spec.ts >> Purchase Negative API Tests @negative >> State Violation: Block Billing a DRAFT PO
- Location: tests/purchase/purchase-negative-api.spec.ts:126:9
...
Error: PO API Creation Failed: 422 - {
	...
	"details": {
		"account_payable_id": [
			"Unable to find Accounts Payable."
		],
		"currency_id": [
			"Unable to find Currency."
		],
		"po_items.0.general_ledger_account_id": [
