...
```
Error: BUG: ERP returns 500 "Unable to create Payment" on approved bill partial payment. Invoice: 80c0f466-2c56-4dff-94b3-3a27c2e5f78b. Error: Bill-Payment API failed: 500 - {
	"code": 500,
