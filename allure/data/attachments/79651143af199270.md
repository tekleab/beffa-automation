...
- Name: purchase/procurement-stress-edge-cases.spec.ts >> Procurement Stress & Financial Edge Cases @purchase @logic @security @regression @full >> Guardrail: System must reject payment exceeding bill total
- Location: tests/purchase/procurement-stress-edge-cases.spec.ts:36:9

# Error details

```
Error: [CRITICAL_LOGIC_BUG] Bill BILL/2026/06/04/000167: Overpayment of 6000 on 3000 bill created negative balance=-3000. Vendor credit injection possible.
```
