...
- Name: sales/sales-period-control-edge-cases.spec.ts >> Sales Period Control Edge Cases @sales @security @temporal @regression >> Edge Case: Verify SO->Invoice->Receipt chain with mixed dates is blocked
- Location: tests/sales/sales-period-control-edge-cases.spec.ts:308:9

# Error details

```
Error: [CRITICAL_PERIOD_CONTROL_BUG] System approved back-dated Invoice in SO->Invoice chain!
```
