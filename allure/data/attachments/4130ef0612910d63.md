...
- Location: tests/cross-module/line-item-miscellaneous-audit.spec.ts:554:9

# Error details

```
Error: [MODAL] Line item modal did not close after clicking Add/Save. Validation errors: Selling price is must be greater than 0
```
