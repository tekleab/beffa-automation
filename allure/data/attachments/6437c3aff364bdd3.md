...
- Name: sales/sales-negative-api.spec.ts >> Sales Order Negative API Tests @negative >> Block Receipt: Missing Cash Account
- Location: tests/sales/sales-negative-api.spec.ts:112:9
