...
```
Error: Invoice INV/2026/06/02/000066 not found in customer profile UI. Customer: 223a2864-674f-42e7-b799-22730e12c57a
```
...
> 66  |             throw new Error(`Invoice ${inv.ref} not found in customer profile UI. Customer: ${meta.customerId}`);
  ...
  118 |         await invoicesTab.waitFor({ state: 'visible', timeout: 150000 });
