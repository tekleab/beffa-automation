...
Call log:
  - → POST http://localhost:8001/api/employees?year=2018&period=yearly&calendar=ec
    ...
    - Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQGJlZmZhLmNvbSIsImV4cCI6MTc4MDE2ODg3MiwiaXNzIjoiTWlraWFzIFlvbmFzIiwicmVmcmVzaF9leHAiOjE3ODAxNjg4NzJ9.X2L1BdJphF7KJUkceVqGRVt6sGCDxOv3U1jU3hVtOuA
    - x-company: sample
