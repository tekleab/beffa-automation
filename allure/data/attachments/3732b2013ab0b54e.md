...
- Name: sales/sales-so-guardrails.spec.ts >> Sales SO Guardrails @sales @logic @regression @full >> Guardrail: System must reject Invoicing for more units than the approved SO
