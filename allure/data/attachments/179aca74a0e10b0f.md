...
- Name: sales/period-control/so-period-control.spec.ts >> Sales Period Control Edge Cases @sales @security @temporal @regression @full >> Invoice: Reject back-dated Invoice from previous fiscal year (2017)
- Location: tests/sales/period-control/so-period-control.spec.ts:109:9
