...
- Name: purchase/po-security.spec.ts >> Procurement Security & Guardrails Audits @purchase @full >> Guardrail: System must explicitly reject historical back-dated bills
- Location: tests/purchase/po-security.spec.ts:160:9

# Error details

```
Error: [CRITICAL_LOGIC_BUG #TEMP-01] ERP fully approved back-dated bill (BILL/2026/09/23/004738, date: 2021-04-29T00:00:00Z)! Temporal immutability is violated.
```
