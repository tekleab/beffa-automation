...
Call log:
  - waiting for locator('#customer_name-input-id, input[name="name"], input[placeholder*="name" i], input[id*="name" i]').first() to be visible
    44 × locator resolved to hidden <input value="" type="text" placeholder="Search by name" class="chakra-input css-1jlznti"/>
                  ...
                  - list [ref=f1e177]:
                    ...
                    - listitem [ref=f1e184]:
                      - link "Detail" [ref=f1e185] [cursor=pointer]:
                        - /url: /receivables/customers/c08e7b6b-73d5-4071-ac1c-a20139975405/detail
