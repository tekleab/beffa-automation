...
- Name: purchase/vendor.spec.ts >> Vendor Lifecycle — Validation & CRUD@purchase @smoke @regression @full >> Validate TIN, create vendor, edit, remove
                  ...
                  - list [ref=e177]:
                    ...
                    - listitem [ref=e184]:
                      - link "Detail" [ref=e185] [cursor=pointer]:
                        - /url: /payables/vendors/5d83487f-5165-4d39-a34a-c209549abc22/detail
              ...
              - generic [ref=e210]:
                - generic [ref=e211]:
                  ...
                  - generic [ref=e213]:
                    ...
                    - paragraph [ref=e215]: VEND/2026/05/25/000104
                    - paragraph [ref=e216]: "Name:"
                    - paragraph [ref=e217]: Pioneer Distributors-1758
...
```ts
  ...
  8  | );
  9  | 
  10 | test.describe('Vendor Lifecycle — Validation & CRUD@purchase @smoke @regression @full', () => {
