...
- Name: sales/accounting-flow-logic.spec.ts >> Accounting & Ledger Flow Logic Audits @logic @sales @full >> Guardrail: System must prevent double-dip overpayments across multi-link receipts
