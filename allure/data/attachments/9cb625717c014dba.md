...
- Name: purchase/procurement-stress-edge-cases.spec.ts >> Procurement Stress & Financial Edge Cases @purchase @logic @security @regression @full >> Guardrail: System must prevent double-billing the same PO
- Location: tests/purchase/procurement-stress-edge-cases.spec.ts:67:9

# Error details

```
Error: [CRITICAL_LOGIC_BUG] Double-billing allowed! PO PO/2026/06/04/000059 billed twice: BILL/2026/06/04/000169 + BILL/2026/06/04/000170. Duplicate liability created.
```
