...
- Name: purchase/purchase-to-sale-flow.spec.ts >> E2E: Purchase to Sale Flow @e2e @smoke @regression @full >> Full cycle: PO → Bill → SO → Invoice → stock reconciled
- Location: tests/purchase/purchase-to-sale-flow.spec.ts:14:9
...
Call log:
  - → GET http://localhost:8001/api/inventory-items?page=1&pageSize=100&year=2018&period=yearly&calendar=ec
    ...
    - x-company: sample
    - Authorization: Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImFkbWluQGJlZmZhLmNvbSIsImV4cCI6MTc4MDE2ODg2MSwiaXNzIjoiTWlraWFzIFlvbmFzIiwicmVmcmVzaF9leHAiOjE3ODAxNjg4NjF9.ot0Gku8xQUaWf_DEo5MfYGJp18pX7Q_xlzbTo8u1gHA
