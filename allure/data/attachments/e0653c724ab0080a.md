...
- Name: purchase/procurement-po-split-bill.spec.ts >> Procurement PO Split Bill Audit @purchase @logic @regression @full >> Audit: PO split into multiple bills — total must never exceed PO quantity
- Location: tests/purchase/procurement-po-split-bill.spec.ts:15:9

# Error details

```
Error: [VULNERABILITY] Split Bill Stock Mismatch
  PO         : PO/2026/06/02/000030 (ID: e247a05e-0bfc-4269-b0ce-a8258f88ae00)
  Bill 1     : BILL/2026/06/02/000081 — 4 units
  Bill 2     : BILL/2026/06/02/000082 — 6 units
  Stock Before: 40
  Stock After : 40
  Expected   : 50
