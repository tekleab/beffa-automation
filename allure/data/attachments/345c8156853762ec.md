...
```
Error: [PERF_BUG] 9.5x degradation (baseline: 13415ms, burst: 127275ms)

expect(received).toBeLessThan(expected)

Expected: < 5
Received:   9.48751397689154
```
...
```ts
  ...
  36  |             cost_method_code: 'FIFO', quantity: 200, unit_cost: 100
  37  |         });
  38  | 
  ...
  77  |             cost_method_code: 'FIFO', quantity: 100, unit_cost: 100
  78  |         });
  79  | 
