...
- Name: sales/sales-period-control-edge-cases.spec.ts >> Sales Period Control Edge Cases @sales @security @temporal @regression @full >> Edge Case: Reject date with negative timestamp (epoch manipulation)
- Location: tests/sales/sales-period-control-edge-cases.spec.ts:283:9
