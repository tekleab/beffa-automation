...
- Name: cross-module/line-item-miscellaneous-audit.spec.ts >> Line Item & Miscellaneous Audit @sales @purchase @logic @regression @full >> PO-UI-02: Add Miscellaneous Line Item via modal → PO total reflects it
- Location: tests/cross-module/line-item-miscellaneous-audit.spec.ts:570:9

# Error details

```
Error: [pickDate] Could not find date trigger button for label "Purchase Order Date"
```
