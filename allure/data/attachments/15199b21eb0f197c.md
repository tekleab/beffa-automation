...
- Location: tests/purchase/bill-payment-load-stress.spec.ts:121:9

# Error details

```
Error: [DOUBLE_PAYMENT_BUG] Race condition allowed: both payments approved concurrently for bill BILL/2026/08/27/002989!
```
