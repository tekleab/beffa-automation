...
- Name: purchase/procurement-period-control-edge-cases.spec.ts >> Procurement Period Control Edge Cases @purchase @security @temporal @regression @full >> Bill: Reject future-dated Bill from next fiscal year (2019)
- Location: tests/purchase/procurement-period-control-edge-cases.spec.ts:132:9

# Error details

```
Error: [CRITICAL_PERIOD_CONTROL_BUG] System approved Bill from next fiscal year!
```
