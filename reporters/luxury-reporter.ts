...
<body class="login-active">
    ...
    <div class="observation-deck">
        <!-- TOP BRANDING & HEARTBEAT -->
        <div style="position: absolute; top: 30px; left: 40px; display: flex; align-items: center; gap: 20px; z-index: 3000;">
        ...
        <!-- ELITE FINANCIAL ANCHOR -->
        <div class="gl-anchor" style="top: 30px; right: 40px;">
        ...
        <div id="ghostRate" class="rate-ghost">0%</div>
        ...
        <!-- VSC CONTEXT (Bottom Right Orbital) -->
        <div class="latency-engine" style="bottom: 120px; right: 40px;">
            ...
            <div id="latencyStatus" style="font-size:0.5rem; text-align:right; margin-top:5px; color:var(--emerald);">SYNC: ACTIVE</div>
        </div>

        <!-- CRYSTAL -->
        <div class="hologram-stage" style="top:45%; pointer-events:none;">
            <div class="crystal">
    ...
    <script>
        ...
        function animateValue(id, start, end, duration, suffix = '%') {
            ...
            const step = () => {
                ...
                // SHARP ALIGNMENT: Strictly use floor to prevent ghost decimal data
        ...
        function animateDashboard(numericRate, failed, total) {
            ...
            animateValue('ghostRate', 0, numericRate, 1500);
