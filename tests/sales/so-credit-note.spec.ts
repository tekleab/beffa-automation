...
test.describe('Sales Return & Stock Recovery @sales @regression', () => {
    ...
    test('Forensic Audit: Invoice Void & Stock Restoration', async ({ page }) => {
        ...
        const itemInfo = await app.api.inventory.createFreshItemWithStockAPI({ cost_method_code: 'FIFO', quantity: 30, unit_cost: 100 });
